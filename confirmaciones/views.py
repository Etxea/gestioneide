...
from gestioneide.models import Asistencia,Year,Grupo
...
class ConsultaEnviarView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        print("Vamos a enviar la consulta")
        #year = Year.objects.get(activo=True)
        for asistencia in consulta.grupo.asistencia_set.all(): #Asistencia.objects.filter(year=year):
