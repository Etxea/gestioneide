...
class TicketBai_Ticket(models.Model):
    ...
    Factura_SerieFactura = models.CharField(max_length=5,default='A2000')
    Factura_NumFactura = models.CharField(max_length=5,default='00001')
    Factura_FechaExpedicionFactura = models.DateField(auto_now_add=True)
    Factura_HoraExpedicionFactura = models.TimeField(auto_now_add=True)
    DatosFactura_DescripcionFactura = models.CharField('Descripción Factura Social',max_length=255,default="Curso Idiomas")
