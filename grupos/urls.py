...
urlpatterns = [
    ...
    url(r'email/horario/(?P<pk>\d+)/$',login_required(GrupoEmailHorarioView.as_view()), name="grupo_email_horario"),
    url(r'email/horario/(?P<pk>\d+)/html$',login_required(GrupoEmailHorarioHtmlView.as_view()), name="grupo_email_horario_html"),
