...
urlpatterns = [
    ...
    url(r'grupos/horario/(?P<grupo_id>\d+)/alumnos/$',login_required(ImprimirGrupoHorarioAlumnos.as_view()), name="imprimir_grupo_horario_alumnos"),
    url(r'grupos/horario/(?P<grupo_id>\d+)/$',login_required(ImprimirGrupoHorario.as_view()), name="imprimir_grupo_horario"),
