...
class CalendarioFestivos(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for mes in lista_meses_1:
            meses.append({"numero": mes, "nombre": calendar.month_name[mes],"calendario": cal.monthdatescalendar(2015,mes)})
        for mes in lista_meses_2:
            meses.append({"numero": mes,"nombre": calendar.month_name[mes],"calendario": cal.monthdatescalendar(2016,mes)})
        context['meses'] = meses
        return context
