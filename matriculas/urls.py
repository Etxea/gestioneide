...
urlpatterns = [
    ...
    ## CURSOS ONLINE
    url(r'curso/$',CursoListViewPublica.as_view(), name="curso_lista_publica"),
    url(r"curso/curso/lista/$", login_required(CursoListView.as_view()), name="curso_lista"),
    url(r'curso/curso/nuevo/$',login_required(CursoCreateView.as_view()), name="curso_nuevo"),
    url(r'curso/pagar/(?P<pk>\d+)/$',MatriculaCursoPayView.as_view(), name="matricula_curso_pagar"),
    url(r'curso/nueva/(?P<curso_id>\d+)/$',MatriculaCursoDirectaCreateView.as_view(), name="matricula_curso_directo_nueva"),
    ...
    url(r"curso/matriculas/lista/$", login_required(MatriculaCursoListView.as_view()), name="matricula_curso_lista"),
    url(r'curso/matricula/ver/(?P<pk>\d+)/$',login_required(MatriculaCursoDetailView.as_view()), name="matricula_curso_detalle"),
    url(r'curso/matricula/editar/(?P<pk>\d+)/$',login_required(MatriculaCursoUpdateView.as_view()), name="matricula_curso_editar"),
